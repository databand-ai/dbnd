...
from dbnd_spark._vendor.airflow.connection import Connection
...
class SparkSubmitHook:
    ...
    def __init__(
        ...
        self._should_track_driver_status = False
        ...
        for line in itr:
            ...
            if self._is_yarn and self._connection["deploy_mode"] == "cluster":
                ...
                if match:
                    ...
                    self.log.info(
                        "Identified spark driver id: %s", self._yarn_application_id
                    )
    ...
    def on_kill(self):
        ...
        if self._submit_sp and self._submit_sp.poll() is None:
            ...
            if self._yarn_application_id:
                self.log.info(
                    "Killing application %s on YARN", self._yarn_application_id
                )
