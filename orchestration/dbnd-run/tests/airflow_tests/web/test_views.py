...
# under the License.
#
# This file has been modified by databand.ai .
...
class TestAirflowBaseViews(AirflowWebAppTest):
    ...
    def test_rendered(self):
        self.assert_view(
            "Airflow.rendered" if AIRFLOW_VERSION_1 else "Airflow.rendered_templates",
            "Rendered Template",
            with_execution_date=True,
            task_id=self.task_af_id,
        )
    ...
    def test_dag_details(self):
        self.assert_view(
            "Airflow.dag_details", "DAG details" if AIRFLOW_VERSION_1 else "DAG Details"
        )
    ...
    def test_success(self):
        ...
        if AIRFLOW_VERSION_1:
            ...
            assert_content_in_response("Redirecting", resp, resp_code=302)
