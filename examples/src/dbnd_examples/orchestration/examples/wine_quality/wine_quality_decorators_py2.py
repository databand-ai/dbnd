...
def predict_wine_quality_push_to_production(endpoint_name="wineapp"):
    from dbnd_examples.orchestration.examples.wine_quality.serving.sagemaker import (
        deploy_to_sagemaker,
        push_image_to_ecr,
    )
    from dbnd_examples.orchestration.examples.wine_quality.serving import docker
    from dbnd_examples.orchestration.examples.wine_quality.serving import sagemaker
