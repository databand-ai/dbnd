...
def task_auto_config(
    ...
    from test_dbnd.settings.autoloaded_config import AutoloadedConfig
        ...
        with new_dbnd_context(
            conf={
                ...
                "core": {
                    ...
                    "user_init": "test_dbnd.settings.autoloaded_config.user_code_load_config",
                },
                "databand": {"module": "test_dbnd.settings.autoloaded_config"},
            }
