...
"""
``databand.date_interval`` provides convenient classes for date algebra.
Everything uses ISO 8601 notation, i.e. YYYY-MM-DD for dates, etc.
There is a corresponding :class:`databand.parameter.DateIntervalParameter` that you can use to parse date intervals.

Example::

    class MyTask(dbnd.Task):
        date_interval = databand.DateIntervalParameter()
...
class DateInterval(object):
    ...
    Example::
       ...
       x = databand.date_interval.Week(2013, 52)
       print x.prev()
