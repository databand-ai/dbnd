...
from dbnd._vendor.dulwich.pack import write_pack_data, write_pack_objects
from dbnd._vendor.dulwich.protocol import (
    _RBUFSIZE,
    CAPABILITIES_REF,
    CAPABILITY_AGENT,
...
from dbnd._vendor.dulwich.refs import ANNOTATED_TAG_SUFFIX, read_info_refs
...
def ParamikoSSHVendor(**kwargs):
    ...
    warnings.warn(
        ...
        DeprecationWarning)
    from dbnd._vendor.dulwich.contrib.paramiko_vendor import ParamikoSSHVendor
