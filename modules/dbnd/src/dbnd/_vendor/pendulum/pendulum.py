...
class Pendulum(Date, datetime.datetime):
    ...
    def _safe_create_datetime_zone(cls, obj):
        ...
        #elif isinstance(obj, datetime.tzinfo) and not isinstance(obj, Timezone) and not "timezone" in str(type(obj)):
        elif isinstance(obj, datetime.tzinfo) and not "timezone" in str(type(obj)):
            # pytz
