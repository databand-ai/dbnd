...
class Target(object):
    """
    A Target is a resource generated by a :py:class:`_TaskWithParams`.
    ...
    Typically, a :py:class:`~_TaskWithParams` will define one or more Targets as output, and the Task
