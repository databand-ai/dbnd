...
public class RandomNames {
    ...
    public static String next() {
        String name = String.format("%s%s%s", LEFT[RANDOM.nextInt(LEFT.length)], "_", RIGHT[RANDOM.nextInt(RIGHT.length)]);
        if ("boring_wozniak".equals(name)) { // Steve Wozniak is not boring
            return next();
        }
        return name;
    }
