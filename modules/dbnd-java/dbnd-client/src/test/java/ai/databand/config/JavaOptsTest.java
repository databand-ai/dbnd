...
class JavaOptsTest {
    ...
    public void testArgsParse() {
        ...
        systemProps.put("dbnd.verbose", "True");
        ...
        assertThat("Key is missing, but should exist", values.containsKey(DBND__VERBOSE), Matchers.equalTo(true));
        assertThat("Wrong value", values.get(DBND__VERBOSE), Matchers.equalTo("True"));
